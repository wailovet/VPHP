...
class Request
{
    ...
    public static $filter_msg = array(
        ...
        Request::FILTER_NOTEMPTY => "所填信息不能为空",
    ...
    public static function data($data_arr, $name, $filter, $is_htmlspecialchars, $is_mysql_real_escape_string)
    {
        $data = $data_arr[$name];
        if ($is_htmlspecialchars) {
            $data = htmlspecialchars($data);
        }
        if ($is_mysql_real_escape_string) {
